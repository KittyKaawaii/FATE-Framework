...
namespace FATE.FATECombat.Runtime.Manager
{
    public class CombatManager : MonoBehaviour
    {
        ...
        public void HandleNestedEffects(CombatEntity targetInfo, List<AbilityEffectsApplied> nestedEffects)
        {
        ...
        public void InitExtraAbility(CombatEntity casterEntity, RPGAbility ability)
        {
            ...
            if (abilityRank.targetType != TARGET_TYPES.GROUND &&
                abilityRank.targetType != TARGET_TYPES.GROUND_LEAP)
            {
            ...
            {
                case TARGET_TYPES.AOE:
                    EXECUTE_AOE_ABILITY(casterEntity, abilityRank);
                    break;

                case TARGET_TYPES.CONE:
                    EXECUTE_CONE_ABILITY(casterEntity, abilityRank);
                    break;

                case TARGET_TYPES.PROJECTILE:
                    StartCoroutine(EXECUTE_PROJECTILE_ABILITY(casterEntity, null, ability, abilityRank));
                    break;

                case TARGET_TYPES.LINEAR:
                    EXECUTE_LINEAR_ABILITY(casterEntity, ability, abilityRank);
                    break;
            }
        }

        private bool checkTarget(CombatEntity casterInfo, CombatEntity targetInfo, RPGAbilityRankData rankREF)
        {
            if (rankREF.targetType != TARGET_TYPES.TARGET_INSTANT && rankREF.targetType != TARGET_TYPES.TARGET_PROJECTILE) return true;
            if (targetInfo == null)
            {
        ...
        public bool UseRequirementsMet(CombatEntity casterInfo, CombatEntity targetInfo, RPGAbility ability, RPGAbilityRankData rankREF, bool abMustBeKnown)
        {
            ...
            if (rankREF.activationType == AbilityActivationType.Casted && !rankREF.castInRun && !casterInfo.CanStartCasting())
            {
               return false;
            }
        ...
        public void HandleAbilityCost(CombatEntity nodeCombatInfo, RPGAbilityRankData rankREF)
        {
        ...
        public void HandleAbilityTypeActions(CombatEntity casterEntity, CombatEntity targetInfo, RPGAbility ability, RPGAbilityRankData abilityRank, bool OnStart)
        {
            ...
            switch (abilityRank.targetType)
            {
                ...
                case TARGET_TYPES.PROJECTILE:
                case TARGET_TYPES.TARGET_PROJECTILE:
                ...
                case TARGET_TYPES.GROUND_LEAP:
                    if (casterEntity != GameState.playerEntity) return;
                    INIT_GROUND_ABILITY(ability, abilityRank);
                    break;

                case TARGET_TYPES.TARGET_INSTANT:
        ...
        private bool HandleInitAbilityStealthActions(CombatEntity casterNode, RPGAbilityRankData rankREF)
        {
        ...
        private bool HandleInitAbilityShapeshiftingActions(CombatEntity casterNode, RPGAbilityRankData rankREF)
        {
        ...
        private void HandleInitAbilityControllerActions(RPGAbilityRankData rankREF)
        {
            GameState.playerEntity.controllerEssentials.AbilityInitActions(rankREF);
        }

        private void HandleInitAbilityActions(CombatEntity casterEntity, RPGAbilityRankData abilityRank)
        {
            if (abilityRank.targetType == TARGET_TYPES.GROUND || abilityRank.targetType == TARGET_TYPES.GROUND_LEAP) return;
        ...
        private void HandleInitAbilityToggleActions(CombatEntity casterNode, RPGAbilityRankData rankREF, RPGAbility ability)
        {
        ...
        public void HandleInitCooldown(CombatEntity casterNode, RPGAbilityRankData rank, RPGAbility ability)
        {
            if (rank.targetType == TARGET_TYPES.GROUND || rank.targetType == TARGET_TYPES.GROUND_LEAP) return;
        ...
        public void InitAbility(CombatEntity casterEntity, RPGAbility thisAbility, RPGAbilityRankData rank, bool abilityKnown)
        {
            ...
            switch (rank.activationType)
            {
                ...
                case AbilityActivationType.Channeled:
                    ...
                    else
                    {
                        ...
                        if (rank.activationType == AbilityActivationType.Channeled)
                        {
                ...
                case AbilityActivationType.Casted:
                    if (rank.targetType == TARGET_TYPES.TARGET_INSTANT || rank.targetType == TARGET_TYPES.TARGET_PROJECTILE)
                    {
                        if (target.IsDead())
                        {
        ...
        private void EXECUTE_LINEAR_ABILITY(CombatEntity nodeCombatInfo, RPGAbility ability, RPGAbilityRankData rankREF)
        {
        ...
        private void EXECUTE_SELF_ABILITY(CombatEntity casterInfo, RPGAbility ability, RPGAbilityRankData rankREF)
        {
            ExecuteAbilityEffects(casterInfo, casterInfo, rankREF);
        }

        private void EXECUTE_AOE_ABILITY(CombatEntity nodeCombatInfo, RPGAbilityRankData rank)
        {
        ...
        private IEnumerator EXECUTE_AOE_ABILITY_PULSE(CombatEntity nodeCombatInfo, RPGAbilityRankData rankREF)
        {
        ...
        private void EXECUTE_CONE_ABILITY(CombatEntity nodeCombatInfo, RPGAbilityRankData rankREF)
        {
            if (rankREF.ConeHitCount == 1)
            {
        ...
        private IEnumerator EXECUTE_CONE_ABILITY_PULSE(CombatEntity nodeCombatInfo, RPGAbilityRankData rankREF)
        {
        ...
        private void EXECUTE_TARGET_INSTANT_ABILITY(CombatEntity casterInfo, CombatEntity targetInfo, RPGAbilityRankData rankREF)
        {
        ...
        private void INIT_GROUND_ABILITY(RPGAbility ability, RPGAbilityRankData rankREF)
        {
            GameState.playerEntity.InitGroundAbility(ability, rankREF);
        }

        public void EXECUTE_GROUND_ABILITY(CombatEntity casterEntity, RPGAbility ability, RPGCombatDATA.CombatVisualActivationType activationType, RPGAbilityRankData abilityRank)
        {

            if (abilityRank.targetType == TARGET_TYPES.GROUND_LEAP)
        ...
        public void EXECUTE_GROUND_ABILITY_HIT(CombatEntity casterInfo, CombatEntity targetInfo, RPGAbility ability, RPGAbilityRankData rankREF)
        {
            ExecuteAbilityEffects(casterInfo, targetInfo, rankREF);
        }

        private ProjectileHitDetection InitProjectileComponents(GameObject projGO, RPGAbilityRankData rankREF)
        {
            // INIT PROJECTILE
        ...
        public void SpawnHitEffect(CombatEntity cbtNode, RPGAbilityRankData rankREF)
        {
        ...
        private IEnumerator EXECUTE_PROJECTILE_ABILITY(CombatEntity casterNode, CombatEntity targetInfo, RPGAbility ab, RPGAbilityRankData rank)
        {
        ...
        public void ExecuteDOTPulse(CombatEntity casterInfo, CombatEntity targetEntity, RPGEffect effect,
            RPGEffect.RPGEffectRankData effectRank, int curStack, RPGAbilityRankData abilityRank)
        {
        ...
        private IEnumerator EFFECTS_LOGIC(RPGEffect effect, RPGEffect.RPGEffectRankData effectRank, CombatEntity casterInfo,
            CombatEntity targetEntity, RPGAbilityRankData abilityRank, float delay)
        {
            if (targetEntity.IsDead()) yield break;
        ...
        private IEnumerator HandleSpreadEffect(CombatEntity casterInfo, CombatEntity targetInfo, RPGEffect effect, int effectRank,
            int maxUnits, float maxDistance, RPGAbilityRankData rankREF, float delay)
        {
            yield return new WaitForSeconds(delay);
        ...
        private void ExecuteAbilityEffects(CombatEntity casterInfo, CombatEntity targetInfo, RPGAbilityRankData rankREF)
        {
        ...
        private void ExecuteCasterEffects(CombatEntity casterInfo, RPGAbilityRankData rankREF)
        {
        ...
        public void HandleOnKillActions(CombatEntity attacker, CombatEntity deadUnit, RPGAbilityRankData rankREF)
        {
            if (rankREF == null) return;
            if (!AbilityHasTag(rankREF, AbilityTags.OnKill)) return;
                ...
                foreach (var t1 in t.Value.stat.statBonuses)
                {
                    switch (t1.statType)
                    {
                        case RPGStat.STAT_TYPE.EFFECT_TRIGGER:
                            ...
                            {
                                if (t2.tagType != AbilityTags.OnKill) continue;
        ...
        public bool AbilityHasTag(RPGAbilityRankData rankREF, AbilityTags tag)
        {
