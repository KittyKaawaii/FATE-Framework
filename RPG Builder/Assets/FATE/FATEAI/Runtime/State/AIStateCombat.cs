...
namespace FATE.FATEAI.Runtime.State
{
    public class AIStateCombat : AIState
    {
        ...
        public virtual bool CanAttack()
        {
            ...
            if (ThisAIEntity.GetAbilities()[randomAbility].ability.ranks[ThisAIEntity.GetAbilities()[randomAbility].abilityRank].targetType == TARGET_TYPES.SELF)
            {
