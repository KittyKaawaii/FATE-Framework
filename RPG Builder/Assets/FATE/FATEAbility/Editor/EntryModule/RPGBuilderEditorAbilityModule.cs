...
namespace FATE.FATEAbility.Editor.EntryModule
{
    public class RPGBuilderEditorAbilityModule : RPGBuilderEditorModule
    {
        ...
        public override void DrawView()
        {
            ...
            if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showBaseInfo)
            {
                ...
                currentEntry.abilityType = (AbilityType) RPGBuilderEditorFields.DrawHorizontalEnum("Type", "?", (int)currentEntry.abilityType,
                    Enum.GetNames(typeof(AbilityType)));
                    ...
                    if (currentEntry.ranks[i].ShowedInEditor)
                    {
                        ...
                        if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showActivation)
                        {
                            ...
                            currentEntry.ranks[i].activationType = 
                                (AbilityActivationType) RPGBuilderEditorFields.DrawHorizontalEnum("Activation type", "?", 
                                    (int)currentEntry.ranks[i].activationType,
                                    Enum.GetNames(typeof(AbilityActivationType)));
                        ...
                        if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showAbilityType)
                        {
                            ...
                            currentEntry.ranks[i].targetType =
                                (TARGET_TYPES) RPGBuilderEditorFields.DrawHorizontalEnum("Ability Mechanic", "",
                                    (int)currentEntry.ranks[i].targetType,
                                    Enum.GetNames(typeof(TARGET_TYPES)));
                            ...
                            if (currentEntry.ranks[i].targetType !=
                                TARGET_TYPES.SELF
                                && currentEntry.ranks[i].targetType !=
                                TARGET_TYPES.TARGET_INSTANT
                                && currentEntry.ranks[i].targetType !=
                                TARGET_TYPES.TARGET_PROJECTILE
                               )
                            {
                            ...
                            if (currentEntry.ranks[i].targetType != TARGET_TYPES.SELF)
                            {
                                ...
                                if (currentEntry.ranks[i].targetType == TARGET_TYPES.TARGET_INSTANT)
                                {
                            ...
                            TARGET_TYPES.SELF)
                        {
                            ...
                            if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showCasterEffectsApplied)
                            {
                                ...
                                {
                                    currentEntry.ranks[i].casterEffectsApplied.Add(new AbilityEffectsApplied());
                                }
                        ...
                        if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showEffectsApplied)
                        {
                            if (RPGBuilderEditorFields.DrawHorizontalAddButton("Add Effect", true))
                            {
                                currentEntry.ranks[i].effectsApplied.Add(new AbilityEffectsApplied());
                            }
                        ...
                        if (RPGBuilderEditor.Instance.EditorFilters.abilityModuleSection.showTags)
                        {
                            ...
                            {
                                currentEntry.ranks[i].tagsData.Add(new AbilityTagsData());
                            }
                            ...
                            for (var a = 0; a < currentEntry.ranks[i].tagsData.Count; a++)
                            {
                                ...
                                currentEntry.ranks[i].tagsData[a].tag =
                                    (AbilityTags) RPGBuilderEditorFields.DrawHorizontalEnum("Applied on", "",
                                        (int)currentEntry.ranks[i].tagsData[a].tag,
                                        Enum.GetNames(typeof(AbilityTags)));
                                if (RPGBuilderEditorFields.DrawSmallRemoveButton())
                                {
                                ...
                                if (currentEntry.ranks[i].tagsData[a].tag == AbilityTags.Shapeshifting ||
                                    currentEntry.ranks[i].tagsData[a].tag == AbilityTags.Stealth)
                                {
