...
namespace FATE.FATEClass.Editor.EntryModule
{
    public class RPGBuilderEditorClassModule : RPGBuilderEditorModule
    {
        ...
        public override void DrawView()
        {
            ...
            if (RPGBuilderEditor.Instance.EditorFilters.classModuleSection.showTalentTree)
            {
                ...
                {
                    currentEntry.talentTrees.Add(new TalentTreesDATA());
                }

                var ThisList2 = serialObj.FindProperty("talentTrees");
                currentEntry.talentTrees = RPGBuilderEditor.Instance.GetTargetObjectOfProperty(ThisList2) as List<TalentTreesDATA>;
            ...
            if (RPGBuilderEditor.Instance.EditorFilters.classModuleSection.showSpellbook)
            {
                ...
                {
                    currentEntry.spellbooks.Add(new SpellbookDATA());
                }

                var ThisList18 = serialObj.FindProperty("spellbooks");
                currentEntry.spellbooks = RPGBuilderEditor.Instance.GetTargetObjectOfProperty(ThisList18) as List<SpellbookDATA>;
